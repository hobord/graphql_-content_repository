...
import { SiteMapRepository } from "@src/Drupal/repositories";
...
const basicPageContentRepository: IBasicPageContentRepository = new DrupalBasicPageContentRepository(
  basicPageContentFactory
);
const basicPageContentService: IBasicPageContentRepository = new BasicPageContentService(
  basicPageContentRepository
);
...
const sitemapService: ISitemapService = new SitemapService(sitemapRepository);
Container.set("SitemapService", sitemapService);
